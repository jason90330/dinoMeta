...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='./output/ssl_tiny/checkpoint.pth', type=str, help="Path to pretrained weights to evaluate.")
    ...
    parser.add_argument('--output_dir', default="./output/ssl_tiny_linear", help='Path to save logs and checkpoints')
