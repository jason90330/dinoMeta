...
if __name__ == '__main__':
    ...
    # parser.add_argument("--image_path", default='../../Siw-m_similar_er/Partial/FunnyeyeGlasses/Partial_Funnyeye_1/0.jpg', type=str, help="Path of the image to load.")
    # parser.add_argument("--image_path", default='../../Siw-m_similar_er/Mask/TransparentMask/Mask_Trans_24/0.jpg', type=str, help="Path of the image to load.")
    # parser.add_argument("--image_path", default='../../Siw-m_similar_er/Live/Train/Live_14/6.jpg', type=str, help="Path of the image to load.")
    # parser.add_argument("--image_path", default='../../Siw-m_similar_er/Partial/PaperGlasses/Partial_Paperglass_36/100.jpg', type=str, help="Path of the image to load.")
    # parser.add_argument("--image_path", default='../../Siw-m_similar_er/Live/Train/Live_13/0.jpg', type=str, help="Path of the image to load.")
    # parser.add_argument("--image_path", default='../../Siw-m_similar_er/Partial/PaperGlasses/Partial_Paperglass_35/8.jpg', type=str, help="Path of the image to load.")
    # parser.add_argument("--image_path", default='../../Siw-m_similar_er/Partial/PaperCut/Partial_Eye_1/0.jpg', type=str, help="Path of the image to load.")
    parser.add_argument("--image_path", default='../../Siw-m_similar_er/Mask/PaperMask/Mask_Paper_2/100.jpg', type=str, help="Path of the image to load.")
