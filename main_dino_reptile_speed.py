...
def train_dino(args):
    ...
    bs_live, bs_normal, bs_strong, bs_back, bs_dark = \
                    len(dataset_live)/6144, len(dataset_normal)/6144,\
                    len(dataset_strong)/6144,len(dataset_back)/6144, \
                    len(dataset_dark)/6144
    ...
    iternum = min(len(data_loader_live),len(data_loader_normal),
